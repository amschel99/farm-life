...
export const SearchBar = ({productsData,setProductsData}) => {
...
console.log(productsData,setProductsData)
  ...
  return (
    <Box sx={{display:'flex',flexDirection:'column',zIndex:100}} >
            <ListSubheader sx={{display:{xs:"none",sm:"block"}}}>
           <TextField
...
<List sx={{flexDirection:"column",display:{xs:'none', sm: showDropDown &&productsData.length>0?'block':'none'},zIndex:500, height:'auto', overflowY:"scroll",backgroundColor:'#fff',maxHeight:'70vh'}}>
